...
public class SignUpActivity extends AppCompatActivity {
    ...
    //Đăng ký lên tài khoản firebase
                        ...
                        if (task.isSuccessful()){
                            ...
                            reference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()){
                                        Intent intent = new Intent(SignUpActivity.this, com.example.chat_gps2.MainActivity.class);
                            ...
                            Toast.makeText(SignUpActivity.this, "Bạn không thể đăng ký", Toast.LENGTH_SHORT).show();
                        }
                    }
                })
        ;
    ...
    private View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if(nameString == ""||emailString == ""||passWordString == ""||retypeString==""
                    ||phoneString == ""){
                Toast.makeText(SignUpActivity.this, "Cần điền đầy đủ các thông tin", Toast.LENGTH_SHORT).show();
            }
                ...
                Toast.makeText(SignUpActivity.this, "Nhập lại mật khẩu bị sai", Toast.LENGTH_SHORT).show();
            }
            else {
                Toast.makeText(SignUpActivity.this, "Đang tạo tài khoản", Toast.LENGTH_SHORT).show();
                register();
            }
